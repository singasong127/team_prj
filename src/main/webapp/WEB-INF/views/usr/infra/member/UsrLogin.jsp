            ...
            <%--FORM CONTENT STARTS FROM HERE!!--%>
            		...
            		<form>
            			<div class="form-floating mb-3">
    	        			<input type="email" name="email" id="email" class="form-control" value="songjy0127@naver.com" placeholder="email">
	            			<label for="email">이메일</label>
            			</div>
            			<div class="form-floating mb-3">

    	        			<input type="password" name="pwd" id="pwd" class="form-control" value="000000" placeholder="password">
