...
public class MainController {
    ...
    // 채팅방 목록
    public static LinkedList<ChatRoom> chatRoomList = new LinkedList<>();
    ...
    // 방 번호로 방 찾기
    public ChatRoom findRoom(String roomNumber) {
        ChatRoom room = ChatRoom.builder().roomNumber(roomNumber).build();
    ...
    // 방 입장하기
    public boolean enterChatRoom(ChatRoom chatRoom, String nickname) {
        ...
        if(chatRoom == null) {
            ...
            addCookie("roomNumber", chatRoom.getRoomNumber());
            return true;
        }
    }
    ...
    public ResponseEntity<?> chatRoomList() {
        return new ResponseEntity<LinkedList<ChatRoom>>(chatRoomList, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> EnterChatRoom(String roomNumber, String nickname){

        // 방 번호로 방 찾기
        ChatRoom chatRoom = findRoom(roomNumber);
    ...
    public Map<String, Object> notification(@DestinationVariable String roomNumber, Map<String, Object> chatRoom) {
        return chatRoom;
    }
